...
//        Assert.assertEquals(2, service.getPositionInQueue());
//    }
//
//    @Test
//    public void queueLengthTest2(){
//        Assert.assertEquals(1, service.getPositionInQueue("331"));
//    }
//
//    @Test
//    public void queueLengthTest3() {
//        Assert.assertEquals(0, service.getPositionInQueue("331", "terveyskeskus"));
//    }
//
//    @Test
//    public void queueLengthTest4(){
//        service.addToQueue("228", "terveyskeskus", "pena");
//        Assert.assertEquals(1, service.getPositionInQueue("228", "terveyskeskus"));
//        service.addToQueue("882", "terveyskeskus", "japi");
//        Assert.assertEquals(1, service.getPositionInQueue("228", "terveyskeskus"));
//        Assert.assertEquals(2, service.getPositionInQueue("882", "terveyskeskus"));
//    }
//
//    @Test
//    public void queueLengthTest5(){
//        service.addToQueue("246", "hammashoito", "peetu");
//        Assert.assertEquals(3, service.getPositionInQueue());
//    }
//
//}
