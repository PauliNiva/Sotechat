...
public class JpaAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication a) throws AuthenticationException {
        ...
        if (person == null) {
            throw new AuthenticationException("Unable to authenticate user " + loginName) {
            };
        }
        ...
        return new UsernamePasswordAuthenticationToken(person.getLoginName(), password, grantedAuths);
    }
